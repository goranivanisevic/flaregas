---
title: "Statistical Analysis of compositional data -- FlareGas -- 18s"
author: "SES"
date: "2024-08-28"
...
```{r explore-data-structure-pr2, warning=FALSE, results='markup'}
rank_names(biom.pr2)
...
```{r cleaning-annotation-names-pr2, echo=FALSE}
tax <- data.frame(tax_table(biom.pr2))
tax.clean <- data.frame(row.names = row.names(tax),
                        Domain = str_replace(tax[,1], "d__", ""),
                        Subdivision = str_replace(tax[,2], "p__", ""),
...
tax_table(biom.pr2) <- as.matrix(tax.clean)
biom.pr2 <- fix_duplicate_tax(biom.pr2)
```
...
```{r filter-data-pr2, warning=FALSE, results='markup'}
...
```{r prevalence-filtering-18s, warning=FALSE, results='markup'}
biom.18s
#tax_stats(biom.18s)
...
```{r relative-abundance, warning=FALSE, results='markup'}
...
<iframe width="100%" height="1000" style="border: 1px solid #464646;" allowfullscreen="" allow="autoplay" data-external="1" src="fig/rel_abundance-distr-18s.pdf"></iframe>

*Centered log-ratio transformation*

```{r clr-transformation, warning=FALSE, results='markup'}
...
<iframe width="100%" height="1000" style="border: 1px solid #464646;" allowfullscreen="" allow="autoplay" data-external="1" src="fig/clr-distr-18s.pdf"></iframe>
...
```{r sample-richness-18s-culture-emu, warning=FALSE}
...
<iframe width="100%" height="510" style="border: 1px solid #464646;" allowfullscreen="" allow="autoplay" data-external="1" src="fig/alpha-diversity-cultures-18s-emu.pdf"></iframe>
<iframe width="100%" height="510" style="border: 1px solid #464646;" allowfullscreen="" allow="autoplay" data-external="1" src="fig/alpha-diversity-times-18s-emu.pdf"></iframe>

**Sample richness in the different culture setups and different time points (minimap2)**

```{r sample-richness-18s-culture-minimap2, warning=FALSE}
alpha_meas = c("Observed", "Chao1", "Shannon", "Simpson")
...
<iframe width="100%" height="510" style="border: 1px solid #464646;" allowfullscreen="" allow="autoplay" data-external="1" src="fig/alpha-diversity-cultures-18s-minimap2.pdf"></iframe>
<iframe width="100%" height="510" style="border: 1px solid #464646;" allowfullscreen="" allow="autoplay" data-external="1" src="fig/alpha-diversity-times-18s-minimap2.pdf"></iframe>
...
<iframe width="100%" height="1000" style="border: 1px solid #464646;" allowfullscreen="" allow="autoplay" data-external="1" src="fig/clr-pca-18s-emu.pdf"></iframe>

**PCA (minimap2)**

```{r pca-18s-minimap2, warning=FALSE}
#biplot
...
<iframe width="100%" height="550" style="border: 1px solid #464646;" allowfullscreen="" allow="autoplay" data-external="1" src="fig/clr-pca-18s-minimap2.pdf"></iframe><br>


### Hierarchical Clustering 

**Unifrac (emu)**
```{r hierarchical-clustering-18s-emu, warning=FALSE}
...
**Unifrac (minimap2)**
```{r hierarchical-clustering-18s-minimap2, warning=FALSE}
# average-link clustering
# Use unifrac on original compositional data: If your data is truly compositional (relative abundances sum to 1), consider using unifrac directly on the untransformed data
...
<iframe width="100%" height="550" style="border: 1px solid #464646;" allowfullscreen="" allow="autoplay" data-external="1" src="fig/aldex-light_clean_usedVSdark-scatter-genus-18s.pdf"></iframe>
...
<iframe width="100%" height="550" style="border: 1px solid #464646;" allowfullscreen="" allow="autoplay" data-external="1" src="fig/aldex-lightVSocean-scatter-genus-18s.pdf"></iframe>
<iframe width="100%" height="550" style="border: 1px solid #464646;" allowfullscreen="" allow="autoplay" data-external="1" src="fig/aldex-darkVSocean-scatter-genus-18s.pdf"></iframe>
...
<iframe width="100%" height="550" style="border: 1px solid #464646;" allowfullscreen="" allow="autoplay" data-external="1" src="fig/deseq2-light_cleanVSdark_clean-scatter-genus-18s.pdf"></iframe><br>
<iframe width="100%" height="550" style="border: 1px solid #464646;" allowfullscreen="" allow="autoplay" data-external="1"
src="fig/deseq2-light_cleanVSdark_clean-volcano-genus-18s.pdf"></iframe>
...
<iframe width="100%" height="550" style="border: 1px solid #464646;" allowfullscreen="" allow="autoplay" data-external="1" src="fig/edger-light_cleanVSdark_clean-scatter-genus-18s.pdf"></iframe>
<iframe width="100%" height="550" style="border: 1px solid #464646;" allowfullscreen="" allow="autoplay" data-external="1" src="fig/edger-light_clean_usedVSdark_clean-scatter-genus-18s.pdf"></iframe>
...
<iframe width="100%" height="550" style="border: 1px solid #464646;" allowfullscreen="" allow="autoplay" data-external="1" src="fig/edger-oceanVSinoculum-scatter-genus-18s.pdf"></iframe><br>
...
<iframe width="100%" height="550" style="border: 1px solid #464646;" allowfullscreen="" allow="autoplay" data-external="1" src="fig/edger-time-course-light-genus-18s-1.pdf"></iframe>
...
<iframe width="100%" height="550" style="border: 1px solid #464646;" allowfullscreen="" allow="autoplay" data-external="1" src="fig/edger-time-course-dark-genus-18s-up-1.pdf"></iframe><br>
<iframe width="100%" height="550" style="border: 1px solid #464646;" allowfullscreen="" allow="autoplay" data-external="1" src="fig/edger-time-course-dark-genus-18s-up-2.pdf"></iframe>


*Compare results of DESeq2 and edgeR on genus level*

```{r differential-abundance-comparison-genus, warning=FALSE, results='markup'}
alpha <- 0.001
# test differential expression: light.clean_gas - dark.clean_gas
gene_list <- list(
...
```{r edger-tests-comparison-genus, warning=FALSE, results='markup'}
alpha <- 0.001
# test differential expression: ocean - (light.clean_gas + light.used_gas + dark.clean_gas)/3
#light
gene_list <- list(
...
```{r network-construction-spring, warning=FALSE, results='markup'}
...
```{r visualize-network-spring, warning=FALSE, results='markup'}
...
<iframe width="100%" height="550" style="border: 1px solid #464646;" allowfullscreen="" allow="autoplay" data-external="1" src="fig/network-spring-18s.pdf"></iframe>

```{r network-construction-genus-spring, warning=FALSE, results='markup'}
...
<iframe width="100%" height="550" style="border: 1px solid #464646;" allowfullscreen="" allow="autoplay" data-external="1" src="fig/network-spring-genus-18s.pdf"></iframe>
...
<iframe width="100%" height="550" style="border: 1px solid #464646;" allowfullscreen="" allow="autoplay" data-external="1" src="fig/network-spring-genus-11hr-18s.pdf"></iframe>


*Pearson's correlation*

```{r network-construction-pearson, warning=FALSE, results='markup'}
...
```{r visualize-network-pearson, warning=FALSE, results='markup'}
...
<iframe width="100%" height="550" style="border: 1px solid #464646;" allowfullscreen="" allow="autoplay" data-external="1" src="fig/network-pearson-18s.pdf"></iframe>

```{r network-construction-genus-pearson, warning=FALSE, results='markup'}
biom.18s.genus.top50 <- prune_taxa(names(sort(taxa_sums(biom.18s.genus), decreasing = TRUE)[1:50]), biom.18s.genus)
tax_table(biom.18s.genus.top50) <- tax_table(biom.18s.genus.top50) %>% as.data.frame() %>% mutate(Genus = str_remove(Genus, "_X*$")) %>% as.matrix()
...
<iframe width="100%" height="550" style="border: 1px solid #464646;" allowfullscreen="" allow="autoplay" data-external="1" src="fig/network-pearson-genus-18s.pdf"></iframe>
...
```{r save-workspace-18s, warning=FALSE}
#save workspace
